...
void ViewManager::Mouse_Position_Callback(GLFWwindow* window, double xMousePos, double yMousePos)
{
	...
	//calculates the X,Y offset values to move around
	float xOffset = xMousePos - gLastX; 
	float yOffset = gLastY - yMousePos;//inverts the Y axis.
...
void ViewManager::ProcessKeyboardEvents(){
	...
	//This will be to change the view type
...
void ViewManager::PrepareSceneView()
{
	...
	if (bOrthographicProjection == true)
	{
			...
			projection = glm::ortho(-10.0f, 10.0f, -5.0f, 5.0f, 0.1f, 100.0f);
